/* 
   ...
   Date of file generation: 11/19/2022, 3:42:25 PM
*/ 
...
// --------------------------------------------------------------------------------------
//  Function ( nonpayable ): safeTransferFrom_254
//  Function duplicated. Oryginal function name: safeTransferFrom
// --------------------------------------------------------------------------------------
const safeTransferFrom_254 = async (from,to,tokenId) => {
  let function_result = "";
  let gasPrice = Math.round(await bcHttpProvider.getGasPrice() * config.gasPriceFactor);
...
// --------------------------------------------------------------------------------------
//  Function ( nonpayable ): safeTransferFrom_12
//  Function duplicated. Oryginal function name: safeTransferFrom
// --------------------------------------------------------------------------------------
const safeTransferFrom_12 = async (from,to,tokenId,data) => {
  let function_result = "";
  let gasPrice = Math.round(await bcHttpProvider.getGasPrice() * config.gasPriceFactor);
